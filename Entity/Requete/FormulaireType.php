...
class FormulaireType
{
    ...
    /**
     * @property \InterInvest\AsponeBundle\Entity\Requete\ZoneType[] $zone
     */
    private $zone = array(
     ...
     *
     * @return self
     * @param \InterInvest\AsponeBundle\Entity\Requete\ZoneType $zone
     */
    public function addToZone(\InterInvest\AsponeBundle\Entity\Requete\ZoneType $zone)
    {
        $this->zone[] = $zone;
        return $this;
    }
     ...
     * Gets as zone
     *
     * @return \InterInvest\AsponeBundle\Entity\Requete\ZoneType[]
     */
