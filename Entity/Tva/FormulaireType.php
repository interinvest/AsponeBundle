...
class FormulaireType
{
    ...
    /**
     * @property \InterInvest\AsponeBundle\Entity\Tva\ZoneType[] $zone
     */
    private $zone = array(
     ...
     *
     * @return self
     * @param \InterInvest\AsponeBundle\Entity\Tva\ZoneType $zone
     */
    public function addToZone(\InterInvest\AsponeBundle\Entity\Tva\ZoneType $zone)
    {
        $this->zone[] = $zone;
        return $this;
    }
     ...
     * Gets as zone
     *
     * @return \InterInvest\AsponeBundle\Entity\Tva\ZoneType[]
     */
